          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formButtonPrimary: 'bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 hover:from-purple-500 hover:via-purple-400 hover:to-purple-500 text-white font-bold text-base shadow-[0_8px_30px_rgba(168,85,247,0.6),0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_12px_50px_rgba(168,85,247,0.8),0_0_40px_rgba(168,85,247,0.6)] hover:scale-[1.03] transition-all duration-300 relative overflow-hidden',
                formFieldInput: 'backdrop-blur-xl bg-gradient-to-br from-white/15 via-white/10 to-white/15 border-2 border-white/35 text-white font-semibold text-base placeholder:text-gray-300 placeholder:font-normal focus:from-white/20 focus:via-white/15 focus:to-white/20 focus:border-purple-400/70 focus:ring-4 focus:ring-purple-400/30 focus:shadow-[0_0_30px_rgba(168,85,247,0.3)] transition-all duration-300 shadow-[inset_0_2px_8px_rgba(0,0,0,0.3)]',
                formFieldLabel: 'text-white font-bold text-sm drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] tracking-wide',
                footerActionLink: 'text-purple-400 font-bold hover:text-purple-300 hover:underline hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.8)] transition-all duration-300 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]',
                ...
                identityPreviewEditButton: 'text-purple-400 font-bold hover:text-purple-300 hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]',
                ...
                formResendCodeLink: 'text-purple-400 font-bold hover:text-purple-300 hover:underline hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.8)]',
                ...
                formFieldInfoText: 'text-purple-400 font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]',
